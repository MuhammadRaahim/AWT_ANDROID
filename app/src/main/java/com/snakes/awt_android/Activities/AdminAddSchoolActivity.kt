...
import com.snakes.awt_android.databinding.ActivityAdminAddSchoolBinding
import kotlinx.coroutines.launch
import java.io.File
import java.util.*

class AdminAddSchoolActivity : AppCompatActivity() {

    private lateinit var binding: ActivityAdminAddSchoolBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminAddSchoolBinding.inflate(layoutInflater)
    ...
    private fun setClickListeners() {
        binding.apply {
            ...
            etDate.setOnClickListener {
                BaseUtils.showDatePicker(etDate, this@AdminAddSchoolActivity)
            }
            etStartTime.setOnClickListener {
                BaseUtils.showTimePicker(etStartTime, this@AdminAddSchoolActivity)
            }
            etEndTime.setOnClickListener {
                BaseUtils.showTimePicker(etEndTime, this@AdminAddSchoolActivity)
            }
    ...
    private fun uploadImageToStorage(imagePath: String) {
        lifecycleScope.launch {
            ...
            val storagePath = "School Images/".plus(uniqueId)
    ...
    private fun addDasterKhawan(image: String) {
        binding.apply {
            val refId  = schoolReference.document()
            val school = SchoolKhana(
                id = refId.id,
            ...
            uploadService(school)
        }
    }

    private fun uploadService(school: SchoolKhana) {
        val ref = schoolReference.document(school.id!!)
        ref.set(school).addOnSuccessListener {
